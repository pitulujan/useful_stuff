-data_engineer.airtight_sensors_history --> boxid,radio_macaddress,export_date,export_hour,radio_upsince,source,cms_id,cms_column
...
-data_engineer.mdm_devices_history --> id,asset_id,custom_rom_version,device_id,client_id,status,mac_address,ssid,created_at,installed_date,deleted_at,export_date
...
-data_engineer.ams_broadsign_migration_devices_history --> bs_host_id,export_date
